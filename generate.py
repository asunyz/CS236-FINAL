...
def generate_imgs(args, g_list, device, mean_latent, name):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--repeat', type=int, default=1) # added
    ...
    for index in range(args.repeat):
      if args.mode == 'viz_imgs':
          generate_imgs(args, g_list, device, mean_latent, index)
      elif args.mode == 'interpolate':
          generate_gif(args, g_list, device, mean_latent, index)
